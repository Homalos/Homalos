...
2. The strategy examples provided by the system are for technical demonstration only, not actual trading guidance

3. The developer does not promise the completeness, accuracy and timeliness of this system

### Article 2 Risk Warning

1. There are inherent risks in the financial market, and historical performance does not predict future performance

2. Actual trading results are affected by multiple factors such as market fluctuations, network delays, and policy changes

3. Users should bear all consequences of trading decisions
...
3. Institutional users need to obtain relevant business qualifications on their own
