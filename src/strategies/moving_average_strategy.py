...
@FileName   : example_strategy_v2.py
@Date       : 2025/7/6 23:00
@Author     : Donny
@Email      : donnymoving@gmail.com
@Software   : PyCharm
@Description: 示例策略 - 演示新架构的使用方法
"""
import asyncio
...
# 策略工厂函数
def create_strategy(strategy_type: str, strategy_id: str, event_bus, params: Dict[str, Any] = None):
    """策略工厂函数"""
    strategies = {
    ...
    return strategy_class(strategy_id, event_bus, params)
