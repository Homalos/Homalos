...
@FileName   : homalos_system.py
@Date       : 2025/7/6 22:00
@Author     : Donny
@Email      : donnymoving@gmail.com
@Software   : PyCharm
@Description: 系统主程序，被start_integrated_web.py调用
"""
import asyncio
import signal
import sys
        ...
        try:
            ...
            if self.event_bus:
                self.event_bus.publish(Event(EventType.SYSTEM_STARTUP_COMPLETE, {
                    ...
                    "components": self._get_system_status()["components"]
                }))
...
"""
        ...
        if self.web_server:
            ...
            info += "事件监控仪表板: http" + f"://{host}:{port}/dashboard\n"
