...
@Software   : PyCharm
@Description: TTS行情网关简化测试 - 专注于基本功能验证
"""
import asyncio
import sys
import time
...
from src.tts.gateway.market_data_gateway import MarketDataGateway, symbol_contract_map
from src.core.logger import get_logger

logger = get_logger("TTSSimpleTest")


class TTSSimpleTester:
    """TTS简化测试器"""
    ...
    async def setup(self):
        ...
        # 创建事件总线
        self.event_bus = EventBus(name="TTSSimpleTest")
        
        # 创建行情网关
        self.market_gateway = MarketDataGateway(self.event_bus, "TTS_MD")
    ...
    async def test_connection(self):
        ...
        try:
            # 发起连接
            self.market_gateway.connect(self.tts_config)
